          ...
          {book?.cover && (
            <>
              ...
              <div className='flex flex-col basis-3/5'>
                ...
                <textarea id='description' name='description' rows={4} className='block w-full p-1 text-gray-800 bg-white border border-gray-200 mb-2 resize-none rounded-lg' placeholder='참고사항이나 특이사항을 입력해주세요.' value={book?.description} onChange={handleChange}></textarea>
